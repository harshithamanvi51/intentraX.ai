...
Emotion-Adaptive User Interface
...
The system delivers a complete interaction loop: Input → Understanding → Decision Support → Contextual Output
...
AI / NLP
OpenAI API (for intent extraction and natural language understanding) Alternative: Rule-based keyword extraction for fallback or offline usage
Data Sources
